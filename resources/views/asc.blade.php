...
<body class="antialiased bg-slate-50 text-slate-900 font-sans selection:bg-[#E51937] selection:text-white">
    ...
    <div class="bg-[#E51937] text-white text-xs font-bold uppercase tracking-widest py-2 px-4 sm:px-8 lg:px-12 flex justify-between items-center z-50 relative shadow-inner">
        <div class="hidden md:flex items-center space-x-6">
            ...
            <span>Est. 1867</span>
            <span>•</span>
            <span>Student Registry & Accounts</span>
        </div>
    ...
    <div class="relative pt-24 pb-28 bg-[#002855] text-white border-b border-[#001a38]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#FFB81C] px-3 py-1 bg-[#001a38] rounded-full border border-slate-700 inline-block">University Registrar Services</span>
            <h1 class="text-5xl md:text-6xl font-serif font-black tracking-tight">
                Academic Service <span class="text-[#FFB81C]">Center (ASC)</span>
            </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-10 shadow-lg space-y-6 flex flex-col justify-between hover:shadow-2xl transition-all hover:-translate-y-1">
                    <div>
                        <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">Course Registration Engine</h3>
                        <p class="text-slate-600 text-base leading-relaxed">Add or drop course credits, view prerequisite department waivers, and verify timetable conflict alerts for the upcoming academic semester.</p>
                    </div>
                    <button onclick="alert('Please log into your active student portal session to perform live course add/drop modifications.')" class="w-full py-4 bg-[#E51937] hover:bg-[#B21B2A] text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-all shadow-lg hover:-translate-y-0.5">Launch Course Scheduler</button>
                </div>

                <!-- Action Card 2 -->
                <div class="bg-white border border-slate-200 rounded-3xl p-10 shadow-lg space-y-6 flex flex-col justify-between hover:shadow-2xl transition-all hover:-translate-y-1">
                    <div>
                        <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">Fee Receipt & Accounting</h3>
                        <p class="text-slate-600 text-base leading-relaxed">View outstanding tuition balances, download cryptographically signed official semester fee receipts, and process bank challan remittances.</p>
                    </div>
                    <button onclick="alert('Connecting to Lumina Accounting Ledger... All student tuition receipts are currently up to date.')" class="w-full py-4 bg-[#002855] hover:bg-[#E51937] text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-all shadow-lg hover:-translate-y-0.5">Download Fee Receipt</button>
                </div>

                <!-- Action Card 3 -->
                <div class="bg-white border border-slate-200 rounded-3xl p-10 shadow-lg space-y-6 flex flex-col justify-between hover:shadow-2xl transition-all hover:-translate-y-1">
                    <div>
                        <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">Official Transcript Vault</h3>
                        <p class="text-slate-600 text-base leading-relaxed">Request official watermarked digital academic transcripts, verify graduation audit checklists, and view cumulative Grade Point Average (GPA) progression.</p>
                    </div>
                    <button onclick="alert('Transcript audit generated successfully. Check your registered student profile inbox for the secure PDF download link.')" class="w-full py-4 bg-[#002855] hover:bg-[#E51937] text-white font-bold text-xs uppercase tracking-wider rounded-lg transition-all shadow-lg hover:-translate-y-0.5">Generate Transcript Audit</button>
                </div>
            </div>
        </div>
    </div>
