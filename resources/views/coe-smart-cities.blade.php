...
<body class="antialiased bg-slate-50 text-slate-900 font-sans selection:bg-[#E51937] selection:text-white">
    ...
    <div class="bg-[#E51937] text-white text-xs font-bold uppercase tracking-widest py-2 px-4 sm:px-8 lg:px-12 flex justify-between items-center z-50 relative shadow-inner">
        <div class="hidden md:flex items-center space-x-6">
            ...
            <span>Est. 1867</span>
            <span>•</span>
            <span>Civil & Urban Innovation</span>
        </div>
    ...
    <div class="relative pt-24 pb-28 bg-[#002855] text-white border-b border-[#001a38]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            ...
            <h1 class="text-5xl md:text-6xl font-serif font-black tracking-tight">
                Urban Infrastructure <span class="text-[#FFB81C]">& Smart Cities</span>
            </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-lg flex flex-col group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=800" alt="Urban Architecture" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-8 flex-1 flex flex-col justify-between space-y-6">
                        <div>
                            <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">Structural Dynamics & Earthquake Lab</h3>
                            <p class="text-slate-600 text-sm leading-relaxed">Boasting a 6-Degrees-of-Freedom seismic shake table capable of testing tall structural scale models against recorded historic seismic shockwaves.</p>
                        </div>
                        <button onclick="alert('Testing schedules are coordinated via the Department of Civil Engineering.')" class="w-full py-3 bg-[#002855] hover:bg-[#E51937] text-white font-bold uppercase tracking-wider rounded-lg transition-all text-xs shadow">Request Shake Table Slot</button>
                    </div>
                </div>

                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-lg flex flex-col group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <img src="https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&q=80&w=800" alt="Smart Metropolitan Grid" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-8 flex-1 flex flex-col justify-between space-y-6">
                        <div>
                            <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">Smart IoT Grid & Traffic Simulation</h3>
                            <p class="text-slate-600 text-sm leading-relaxed">Executing city-scale microscopic traffic simulation and intelligent automated signaling routines to optimize public commute emissions and reduce gridlocks.</p>
                        </div>
                        <button onclick="alert('Consultancy reports and simulation data are accessible via IRBS.')" class="w-full py-3 bg-[#002855] hover:bg-[#E51937] text-white font-bold uppercase tracking-wider rounded-lg transition-all text-xs shadow">View Simulation Models</button>
                    </div>
                </div>

                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-lg flex flex-col group hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800" alt="Geospatial AI" class="w-full h-60 object-cover group-hover:scale-105 transition-transform duration-500">
                    <div class="p-8 flex-1 flex flex-col justify-between space-y-6">
                        <div>
                            <h3 class="text-2xl font-serif font-bold text-[#002855] mb-3">GIS Geospatial Intelligence Engine</h3>
                            <p class="text-slate-600 text-sm leading-relaxed">Processing multi-spectral satellite imagery using deep learning to track urban heat islands, evaluate forestry depletion, and monitor coastal erosion.</p>
                        </div>
                        <button onclick="alert('Satellite GIS map layers are available for corporate partners via IRBS.')" class="w-full py-3 bg-[#002855] hover:bg-[#E51937] text-white font-bold uppercase tracking-wider rounded-lg transition-all text-xs shadow">Access GIS Repository</button>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl p-10 max-w-4xl mx-auto text-center space-y-6 shadow-md">
                <h3 class="text-3xl font-serif font-bold text-[#002855]">Municipal & Government Advisory</h3>
                <p class="text-slate-600 text-base leading-relaxed">Our Center of Excellence serves as the principal technical advisor for multiple municipal corporations, smart city development authorities, and national highway boards.</p>
                <div class="pt-2">
                    <a href="{{ route('contact') }}" class="inline-flex items-center px-8 py-4 bg-[#E51937] hover:bg-[#B21B2A] text-white rounded-lg font-bold text-sm uppercase tracking-wider transition-all shadow-lg hover:-translate-y-0.5">Contact Principal Advisory Board</a>
                </div>
            </div>
        </div>
    </div>
