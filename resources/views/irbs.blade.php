...
<head>
    ...
    <title>IRBS - Institutional Research & Bibliographic System | Lumina University</title>
...
<body class="antialiased bg-slate-50 text-slate-900 font-sans selection:bg-[#E51937] selection:text-white">
    ...
    <div class="bg-[#E51937] text-white text-xs font-bold uppercase tracking-widest py-2 px-4 sm:px-8 lg:px-12 flex justify-between items-center z-50 relative shadow-inner">
        <div class="hidden md:flex items-center space-x-6">
            ...
            <span>Est. 1867</span>
            <span>•</span>
            <span>Research & Digital Archives</span>
        </div>
    ...
    <div class="relative pt-24 pb-28 bg-[#002855] text-white border-b border-[#001a38]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#FFB81C] px-3 py-1 bg-[#001a38] rounded-full border border-slate-700 inline-block">University Archival Network</span>
            <h1 class="text-5xl md:text-6xl font-serif font-black tracking-tight">
                Institutional Research & <span class="text-[#FFB81C]">Bibliographic System</span>
            </h1>
    ...
    <div class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div class="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-xl space-y-8">
                <h2 class="text-3xl font-serif font-bold text-[#002855]">Search Published Research</h2>
                <form onsubmit="event.preventDefault(); alert('Querying IRBS Digital Archive... Found 42 published papers and 3 active patents matching your criteria.');" class="flex flex-col md:flex-row gap-6">
                    <input type="text" required class="flex-1 p-4 bg-slate-50 border border-slate-300 rounded-xl text-slate-900 focus:ring-2 focus:ring-[#002855] focus:border-[#002855] transition-all" placeholder="Search by paper title, DOI, faculty author, or research grant ID...">
                    <button type="submit" class="px-8 py-4 bg-[#E51937] hover:bg-[#B21B2A] text-white font-bold text-sm uppercase tracking-wider rounded-xl shadow-lg transition-all hover:-translate-y-0.5">Search Bibliography</button>
                </form>
            </div>

            <!-- Active Research Highlights -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <div class="bg-white border border-slate-200 rounded-2xl p-8 space-y-6 shadow-lg hover:shadow-2xl transition-all flex flex-col justify-between hover:-translate-y-1">
                    <div>
                        <span class="text-xs font-mono font-bold text-[#E51937] bg-red-50 px-3 py-1 rounded border border-red-200 inline-block mb-4">GRANT-2026-AI</span>
                        <h3 class="text-xl font-serif font-bold text-[#002855] mb-3">Neuro-Symbolic LLM Architectures</h3>
                        <p class="text-slate-600 text-sm leading-relaxed">Investigating hybrid artificial intelligence models combining deep neural attention mechanisms with strict rule-based symbolic verification fences.</p>
                    </div>
                    <div class="pt-4 border-t border-slate-200 flex justify-between text-xs text-slate-500 font-bold">
                        <span>Lead: Prof. Jonathan Vance</span>
                        <span class="text-[#002855]">Active ($1.2M)</span>
                    </div>
                </div>

                <div class="bg-white border border-slate-200 rounded-2xl p-8 space-y-6 shadow-lg hover:shadow-2xl transition-all flex flex-col justify-between hover:-translate-y-1">
                    <div>
                        <span class="text-xs font-mono font-bold text-[#E51937] bg-red-50 px-3 py-1 rounded border border-red-200 inline-block mb-4">PATENT-BIO-882</span>
                        <h3 class="text-xl font-serif font-bold text-[#002855] mb-3">Targeted Nanomaterial Delivery</h3>
                        <p class="text-slate-600 text-sm leading-relaxed">Synthesis of biocompatible mesoporous carbon nanocarriers for high-precision oncological pharmaceutical drug delivery systems.</p>
                    </div>
                    <div class="pt-4 border-t border-slate-200 flex justify-between text-xs text-slate-500 font-bold">
                        <span>Lead: Dr. Elena Rostova</span>
                        <span class="text-[#002855]">Filed & Published</span>
                    </div>
                </div>

                <div class="bg-white border border-slate-200 rounded-2xl p-8 space-y-6 shadow-lg hover:shadow-2xl transition-all flex flex-col justify-between hover:-translate-y-1">
                    <div>
                        <span class="text-xs font-mono font-bold text-[#E51937] bg-red-50 px-3 py-1 rounded border border-red-200 inline-block mb-4">THESIS-CS-2026</span>
                        <h3 class="text-xl font-serif font-bold text-[#002855] mb-3">Quantum Encryption Fencing</h3>
                        <p class="text-slate-600 text-sm leading-relaxed">Lattice-based cryptographic protocol architecture resistant to decryption attacks originating from next-generation quantum processing engines.</p>
                    </div>
                    <div class="pt-4 border-t border-slate-200 flex justify-between text-xs text-slate-500 font-bold">
                        <span>Ph.D. Scholar: Marcus Thorne</span>
                        <span class="text-[#002855]">Completed</span>
                    </div>
                </div>
            </div>
        </div>
