    ...
    <div class="py-24 bg-slate-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div class="border-b-2 border-[#002855] pb-8">
                ...
                <h1 class="text-5xl font-serif font-bold text-[#002855] mb-4">Terms of Service</h1>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl p-8 md:p-12 shadow-lg space-y-10 text-slate-700 leading-relaxed text-base">
                <section class="space-y-4">
                    <h2 class="text-2xl font-serif font-bold text-[#002855]">1. Agreement to Terms</h2>
                ...
                <section class="space-y-4">
                    <h2 class="text-2xl font-serif font-bold text-[#002855]">2. User Accounts & Responsibilities</h2>
                    <p>You are strictly responsible for maintaining the confidentiality of your credentials (<code>admin@demo.com</code>, <code>teacher1@demo.com</code>, <code>student@demo.com</code>). Any activity originating from your active session is legally attributed to your account.</p>
                </section>

                <section class="space-y-4">
                    <h2 class="text-2xl font-serif font-bold text-[#002855]">3. Academic Integrity & System Modification</h2>
