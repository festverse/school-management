...
<head>
    ...
    <title>Placement & Training Cell | Lumina University</title>
...
<body class="antialiased bg-slate-50 text-slate-900 font-sans selection:bg-[#E51937] selection:text-white">
    ...
    <div class="bg-[#E51937] text-white text-xs font-bold uppercase tracking-widest py-2 px-4 sm:px-8 lg:px-12 flex justify-between items-center z-50 relative shadow-inner">
        <div class="hidden md:flex items-center space-x-6">
            ...
            <span>Est. 1867</span>
            <span>•</span>
            <span>Corporate Relations & Placement</span>
        </div>
    ...
    <div class="relative pt-24 pb-28 bg-[#002855] text-white border-b border-[#001a38]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#FFB81C] px-3 py-1 bg-[#001a38] rounded-full border border-slate-700 inline-block">Career Placement Desk</span>
            <h1 class="text-5xl md:text-6xl font-serif font-black tracking-tight">
                Placement & <span class="text-[#FFB81C]">Training Cell</span>
            </h1>
            <p class="max-w-3xl text-lg text-slate-200 mx-auto font-normal leading-relaxed">
                Bridging world-class engineering talent with global corporate giants. Our robust corporate interface ensures exceptional internship opportunities and elite full-time career packages.
            </p>
        </div>
    </div>
    ...
    <div class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all">
                    <h3 class="text-4xl font-serif font-black text-[#002855] mb-2">₹62.5 LPA</h3>
                    <p class="text-slate-600 text-sm font-bold uppercase tracking-wider">Highest CTC Offered</p>
                </div>
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all">
                    <h3 class="text-4xl font-serif font-black text-[#E51937] mb-2">₹18.4 LPA</h3>
                    <p class="text-slate-600 text-sm font-bold uppercase tracking-wider">Average CTC Package</p>
                </div>
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all">
                    <h3 class="text-4xl font-serif font-black text-[#002855] mb-2">98.4%</h3>
                    <p class="text-slate-600 text-sm font-bold uppercase tracking-wider">Placement Success Rate</p>
                </div>
                <div class="bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all">
                    <h3 class="text-4xl font-serif font-black text-[#E51937] mb-2">350+</h3>
                    <p class="text-slate-600 text-sm font-bold uppercase tracking-wider">Global Hiring Partners</p>
                </div>
            </div>

            <!-- Top Recruiters Grid -->
            <div class="bg-white border border-slate-200 rounded-2xl p-12 text-center space-y-8 shadow-xl">
                <h3 class="text-3xl font-serif font-bold text-[#002855]">Top Corporate Recruitment Partners</h3>
                <p class="text-slate-600 max-w-2xl mx-auto font-medium leading-relaxed">We maintain strong talent supply agreements with world leaders across Information Technology, Core Engineering, Strategy Consulting, and Investment Banking.</p>
                
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-4">
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">GOOGLE</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">MICROSOFT</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">SIEMENS</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">LARSEN & TOUBRO</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">GOLDMAN SACHS</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">AMAZON</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">BOSCH</div>
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center font-serif font-bold text-xl text-[#002855] tracking-wider shadow-sm">TATA MOTORS</div>
                </div>

                <div class="pt-8 flex flex-wrap justify-center gap-6">
                    <button onclick="alert('Downloading official Placement Brochure (2026-2027) PDF...')" class="px-8 py-4 bg-[#E51937] hover:bg-[#B21B2A] text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-all shadow-lg hover:-translate-y-0.5">Download Placement Brochure</button>
                    <a href="{{ route('contact') }}" class="px-8 py-4 bg-[#002855] hover:bg-[#003366] text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-all shadow-lg hover:-translate-y-0.5">Contact Placement Officer</a>
                </div>
            </div>
        </div>
    </div>
