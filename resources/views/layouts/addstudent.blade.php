                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('add-student') }}" enctype="multipart/form-data">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <input name="student_image_upload" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" enctype="multipart/form-data">    
                        </div>
                        ...
                        <div class="grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="mName" id="mName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-3 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="brgy" id="brgy" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
