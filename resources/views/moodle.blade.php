...
<body class="antialiased bg-slate-50 text-slate-900 font-sans selection:bg-[#E51937] selection:text-white">
    ...
    <div class="relative pt-24 pb-28 bg-[#002855] text-white border-b border-[#001a38]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
            <span class="text-xs font-bold uppercase tracking-widest text-[#FFB81C] px-3 py-1 bg-[#001a38] rounded-full border border-slate-700 inline-block">Digital Learning Engine</span>
            <h1 class="text-5xl md:text-6xl font-serif font-black tracking-tight">
                Lumina <span class="text-[#FFB81C]">Moodle LMS</span>
            </h1>
    ...
    <div class="py-24 bg-slate-50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div class="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 shadow-xl text-center space-y-8">
                <div class="w-20 h-20 bg-[#002855] rounded-3xl mx-auto flex items-center justify-center text-4xl text-white shadow-lg">
                    💻
                </div>
                <h2 class="text-3xl font-serif font-bold text-[#002855]">Seamless Cloud Integration</h2>
                <p class="text-slate-600 font-medium max-w-2xl mx-auto leading-relaxed">Lumina Moodle is directly federated with your primary student and faculty RBAC credentials. All course enrollments, active assignment deadlines, and grading tables synchronize automatically with the core database engine.</p>
                
                <div class="pt-4 flex flex-col sm:flex-row justify-center gap-6">
                    <a href="{{ route('login') }}" class="px-8 py-4 bg-[#E51937] hover:bg-[#B21B2A] text-white font-bold text-xs uppercase tracking-wider rounded-xl shadow-lg transition-all hover:-translate-y-0.5">Log in to Moodle Dashboard</a>
                    <button onclick="alert('Moodle mobile app configuration settings downloaded. Use server URL: https://school-management-1-hqy0.onrender.com/moodle')" class="px-8 py-4 bg-[#002855] hover:bg-[#003366] text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-lg hover:-translate-y-0.5">Download Mobile Config</button>
                </div>
            </div>
        </div>
    </div>
