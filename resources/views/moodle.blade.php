...
<head>
    ...
    <title>Moodle LMS - Lumina University</title>
    ...
    <style>
        ...
        .text-gradient { background: linear-gradient(to right, #fb923c, #ea580c); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
    </style>
</head>
<body class="antialiased bg-gray-900 text-gray-100 font-sans selection:bg-primary-500 selection:text-white">
    ...
    <div class="relative pt-32 pb-20 hero-gradient flex items-center overflow-hidden border-b border-gray-800">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange-600/10 rounded-full blur-3xl opacity-40 pointer-events-none"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-6xl font-display font-extrabold tracking-tight text-white mb-6">
                Lumina <span class="text-gradient">Moodle LMS</span>
            </h1>
            <p class="max-w-2xl text-lg text-gray-400 mx-auto font-light">
                The elite digital classroom environment. Access dynamic course lecture materials, submit weekly research assignments, take secure online quizzes, and participate in peer forum debates.
            </p>
        </div>
    </div>
    ...
    <div class="py-24 bg-gray-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div class="bg-gray-800/40 border border-gray-700/50 rounded-3xl p-8 md:p-12 shadow-2xl text-center space-y-8">
                <div class="w-20 h-20 bg-orange-500/10 border border-orange-500/20 rounded-3xl mx-auto flex items-center justify-center text-4xl text-orange-500">
                    💻
                </div>
                <h2 class="text-3xl font-display font-bold text-white">Seamless Cloud Integration</h2>
                <p class="text-gray-300 font-light max-w-2xl mx-auto leading-relaxed">Lumina Moodle is directly federated with your primary student and faculty RBAC credentials. All course enrollments, active assignment deadlines, and grading tables synchronize automatically with the core database engine.</p>
                
                <div class="pt-4 flex flex-col sm:flex-row justify-center gap-6">
                    <a href="{{ route('login') }}" class="px-8 py-4 bg-orange-600 hover:bg-orange-500 text-white font-semibold rounded-xl shadow-lg shadow-orange-600/20 transition-all hover:-translate-y-0.5">Log in to Moodle Dashboard</a>
                    <button onclick="alert('Moodle mobile app configuration settings downloaded. Use server URL: https://school-management-1-hqy0.onrender.com/moodle')" class="px-8 py-4 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-xl border border-gray-600 transition-all">Download Mobile Config</button>
                </div>
            </div>
        </div>
    </div>
