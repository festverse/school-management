...
<body class="antialiased bg-gray-900 text-gray-100 font-sans selection:bg-primary-500 selection:text-white">
    ...
    <div class="relative pt-32 pb-20 hero-gradient flex items-center overflow-hidden border-b border-gray-800">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-amber-600/10 rounded-full blur-3xl opacity-40 pointer-events-none"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-6xl font-display font-extrabold tracking-tight text-white mb-6">
                SC/ST & <span class="text-gradient">Equal Opportunity Cell</span>
            </h1>
    ...
    <div class="py-24 bg-gray-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            <div class="bg-gray-800/40 border border-gray-700/50 rounded-3xl p-8 md:p-12 shadow-2xl space-y-8">
                <div>
                    <h2 class="text-3xl font-display font-bold text-white mb-4">Core Objectives & Activities</h2>
                    <ul class="space-y-4 text-gray-300 font-light leading-relaxed">
                ...
                <div class="pt-8 border-t border-gray-700/50 flex flex-col sm:flex-row gap-6">
                    <button onclick="alert('Scholarship claim forms are successfully bound to your active student dashboard profile.')" class="flex-1 py-4 bg-amber-600 hover:bg-amber-500 text-white font-semibold rounded-xl shadow-lg shadow-amber-600/20 transition-all">Claim Scheme Scholarship</button>
                    <button onclick="alert('Mentorship appointment logged. An academic advisor will reach out to you shortly.')" class="flex-1 py-4 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-xl border border-gray-600 transition-all">Request Academic Advisor</button>
                </div>
            </div>
        </div>
    </div>
